        ...
        <DarkModeParent theme={usedTheme}>
            ...
            <div style={{ display: "flex", justifyContent: "center", marginTop: "10px" }}>
                <a style={{ marginRight: "5px" }} href={"https://apps.apple.com/us/app/discord-talk-chat-hang-out/id985746746"}>
                    <img alt="discord app" style={{ height: "50px" }} src={"images/common/Download_on_the_App_Store_Badge_FR_RGB_blk_100517.svg"} />
                </a>
                <a style={{ marginLeft: "5px" }} href={"https://play.google.com/store/apps/details?id=com.discord"}>
                    <img alt="soto google play" style={{ height: "50px" }} src={"images/common/google-play-badge.png"} />
                </a>
            </div>
                ...
                <Grid container justify={'center'} wrap={'wrap'} alignContent={'space-around'}>
                    <Grid item xs={4}>
                        ...
                        <div style={{ display: "flex", justifyContent: "center", marginBottom: "20px" }}>
                            <div>
                                <img alt="soto developpeur" style={{ width: "175px", height: "200px", margin: "5px" }} src={"images/team/arnaud.jpg"} />
                                <Typography align={"center"}>Arnaud MOTTE</Typography>
                            </div>
                            <div>
                                <img alt="soto developpeur" style={{ width: "175px", height: "200px", margin: "5px" }} src={"images/team/nicolas.jpg"} />
                    ...
                    <Grid item xs={4}>
                        ...
                        <div style={{ display: "flex", justifyContent: "center", marginBottom: "20px" }}>
                            <div>
                                <img alt="soto developpeur" style={{ width: "175px", height: "200px", margin: "5px" }} src={"images/team/tom.jpg"} />
                                <Typography align={"center"}>Tom FLORENTIN</Typography>
                            </div>
                            <div>
                                <img alt="soto developpeur" style={{ width: "175px", height: "200px", margin: "5px" }} src={"images/team/quentin.jpg"} />
                    ...
                    <Grid item xs={4}>
                        ...
                        <div style={{ display: "flex", justifyContent: "center" }}>
                            <div>
                                <img alt="soto developpeur" style={{ width: "175px", height: "200px", margin: "5px" }} src={"images/team/loup.jpg"} />
                                <Typography align={"center"}>Loup MASNERI</Typography>
                            </div>
                            <div>
                                <img alt="soto developpeur" style={{ width: "175px", height: "200px", margin: "5px" }} src={"images/team/pq.jpg"} />
