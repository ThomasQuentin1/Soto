...
export const CriterionsDocument = gql`
    query Criterions {
  criterions {
    activated
    id
...
/**
 * __useCriterionsQuery__
 *
 * To run a query within a React component, call `useCriterionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useCriterionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCriterionsQuery({
 *   variables: {
 *   },
 * });
 */
...
export const ObligationsDocument = gql`
    query Obligations {
  obligations {
    activated
    id
...
/**
 * __useObligationsQuery__
 *
 * To run a query within a React component, call `useObligationsQuery` and pass it any options that fit your needs.
 * When your component renders, `useObligationsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useObligationsQuery({
 *   variables: {
 *   },
 * });
 */
