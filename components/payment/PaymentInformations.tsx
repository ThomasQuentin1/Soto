...
const PaymentInformation = ({cart, loading, cardValues, setCardValues, expirationDateValues, setExpirationDateValues, cryptogramValues, setCryptogramValues, userName, setUserName, setNextButtonEnabled, fullAdress, setFullAdress, zipCodeValues, setZipCodeValues} : PaymentInformationProps) => {
    ...
    return (
        <Grid container spacing={2} style={{textAlign:"left", paddingLeft:"35px", marginBottom:"10px"}}>
            <Grid item xs={6}>
            <Typography style={{textDecoration:"underline", marginBottom:"5px"}}>Information de paiement</Typography>
                <FormControl>
                    {cardErrorText ? 
                        <TextField
                            required 
            ...
            <Grid item xs={12}>
                    ...
                    <Grid container>
                        ...
                        {fullAdressErrorText ? 
                            ...
                            onChange={(event: any) => handleChangeText(event, setFullAdress)} label="Adresse complète" margin="dense" color="secondary" type="text" helperText="Champ requis"></TextField>
                            : 
                            ...
                            onChange={(event: any) => handleChangeText(event, setFullAdress)} label="Adresse complète" margin="dense" color="secondary" type="text"></TextField>}
                        </Grid>
                    </Grid>
            </Grid>
        </Grid>
